    ...
    return (
        <ReactMarkdown
            ...
            components={{
                ...
                h1(props) {
                    return (
                        <UIText type={UITextType.h1} source={props.children} />
                    );
                },
                h2(props) {
                    return (
                        <UIText type={UITextType.h2} source={props.children} />
                    );
                },
                h3(props) {
                    return (
                        <UIText type={UITextType.h3} source={props.children} />
                    );
                },
                h4(props) {
                    return (
                        <UIText type={UITextType.h4} source={props.children} />
                    );
                },
                h5(props) {
                    return (
                        <UIText type={UITextType.h5} source={props.children} />
                    );
                },
                h6(props) {
                    return (
                        <UIText type={UITextType.h6} source={props.children} />
                    );
                },
                p(props) {
                    return (
                        <UIText type={UITextType.p} source={props.children} />
                    );
                }
            }}
        >
