        ...
        case LoadingSkeletonType.image:
            return (
                <div
                    role="status"
                    className={
                        "mx-auto max-w-sm animate-pulse lg:max-w-lg" + className
                    }
                >
                    <div className="flex h-48 w-full items-center justify-center rounded bg-gray-300 dark:bg-gray-700">
                        <svg
                            className="h-10 w-10 text-gray-200 dark:text-gray-600 lg:h-24 lg:w-24"
                            aria-hidden="true"
        ...
        case LoadingSkeletonType.text:
            return (
                <div
                    role="status"
                    className={
                        "mx-auto max-w-sm animate-pulse lg:max-w-lg " +
                        className
                    }
                >
        ...
        case LoadingSkeletonType.imageAndText:
            return (
                <div
                    role="status"
                    className={
                        "mx-auto max-w-sm animate-pulse space-y-8 rtl:space-x-reverse md:flex md:items-center md:space-x-8 md:space-y-0 lg:max-w-lg " +
                        className
                    }
                >
